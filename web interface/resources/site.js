...
(function() {
  var AudioVisualizer, Firework, ParticleVisualizer, SeededRand, Star, audioVisualizer, extend, fireworkEntities, fireworks, fireworksCanvas, fireworksName, form, getDt, main, updateFireworks,
  ...
  Firework = (function() {
    ...
    function Firework(rand, config) {
      ...
      this.targetX = this.rand.nextRange(this.startX - innerWidth / 10, this.startX + innerWidth / 10);
      ...
      this.brightness = this.rand.nextInt(50, 80);
    ...
    Firework.prototype.draw = function() {
      ...
      if (this.showShockwave) {
        ...
        this.cx.strokeStyle = "hsla(" + this.hue + ", 100%, " + this.brightness + ", " + (rand.nextRange(25, 65) / 100) + ")";
        this.cx.lineWidth = this.lineWidth;
        this.cx.stroke();
  ...
  Star = (function() {
    ...
    function Star(rand, x, y, baseHue, config) {
      ...
      this.hue = this.rand.nextRange(this.hue - this.config.hueVariance, this.hue + this.config.hueVariance);
